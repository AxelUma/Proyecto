...
import LogicaNegocio.BL_Empleado;
...
public class EliminarEmpleado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            int resultado = 0;
            int id; //Guardamos el valor recibido
            if(request.getParameter("txtIdempleado") != null && 
                ...
                resultado = logica.Eliminar(new Empleado(id, "","","", "","", "", 0));
                response.sendRedirect("Frm_ListarEmpleados.jsp?mensaje=" + logica.getMensaje());
            }
