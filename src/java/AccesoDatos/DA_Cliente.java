...
public class DA_Cliente {
    ...
    public int Modificar(Cliente EntidadCliente) throws Exception {
        ...
        try {
            ...
            PreparedStatement ps = _conexion.prepareStatement("UPDATE CLIENTES SET CEDULA=?, NOMBRE_C=?, TELEFONO=?, CORREO=? WHERE ID = ?");

            ps.setString(1, EntidadCliente.getCedula());
            ps.setString(2, EntidadCliente.getNombre());
            ps.setString(3, EntidadCliente.getTelefono());
            ps.setString(4, EntidadCliente.getCorreo());
            ps.setInt(5, EntidadCliente.getId());
    ...
    */
    ...
    public List<Cliente> ListarRegistros(String Condicion) throws Exception {
        ...
        try {
            ...
            Sentencia = "SELECT ID, CEDULA, NOMBRE_C, TELEFONO, CORREO FROM CLIENTES";
