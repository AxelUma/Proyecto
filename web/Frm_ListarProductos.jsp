                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><%= new String(registro.getProducto().getBytes("ISO-8859-1"), "UTF-8") + " (" + new String(registro.getCodigo().getBytes("ISO-8859-1"), "UTF-8") + ") " + new String(registro.getModelo().getBytes("ISO-8859-1"), "UTF-8")%></td>
