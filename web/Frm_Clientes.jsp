                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <%
                        ...
                        if (codigo > 0) {
                            ...
                            cliente = logica.ObtenerRegistro("ID=" + id);
                        } else {
                            // Sino, crea uno nuevo
                            cliente = new Cliente();
                        }
                    ...
                    <form action="CrearModificarCliente" method="post" id="form_AgregarModificar">
                        ...
                        <div class="form-group">
                            ...
                            <input type="txt" id="txtCedula" name="txtCedula" value="<%=cliente.getCedula()%>" class="form-control"/><br>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="txt" id="txtCorreo" name="txtCorreo" value="<%=cliente.getCorreo()%>" class="form-control"/><br>
                        </div>
