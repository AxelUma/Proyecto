                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <form action="Frm_ListarProductos.jsp" method="post">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" id="txtnombre" name="txtnombre" value="" placeholder="Producto" class="form-control"/>&nbsp; &nbsp;
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <th style="text-align: left">Precio V</th>
                            <th style="text-align: left">Precio C</th>
                        ...
                        <%
                            ...
                            if (request.getParameter("txtnombre") != null
                                ...
                                condicion += " and producto like '%" + nombre + "%'";
                            }
                        ...
                        <tr>
                            ...
                            <td><%= new String(registro.getCodigo().getBytes("ISO-8859-1"), "UTF-8") + " " + new String(registro.getProducto().getBytes("ISO-8859-1"), "UTF-8") + " " + new String(registro.getModelo().getBytes("ISO-8859-1"), "UTF-8")%></td>
                    ...
                    <a href="Frm_ListarProductos.jsp" class="btn btn-primary">Actualizar</a>
